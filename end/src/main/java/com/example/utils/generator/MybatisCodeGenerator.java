...
public class MybatisCodeGenerator {
    ...
    private static final String schemaName = "zyj";   // 数据库名称，必填
    private static final String[] table = {"collect", ""};   // 必填，第一个是表名，第二个是实体类的名字
    private static final String modelName = "收藏";   // 必填
    ...
    static void createVue(String entityName, String tableName) throws SQLException {
        ...
        FileUtil.writeString(format, BaseFilePath + "/utils/generator/vue/" + lowerEntityName + ".vue", "UTF-8");
