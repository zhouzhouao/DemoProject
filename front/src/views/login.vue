<template>
  <div>
    <div style="width: 100%; height: 100vh; overflow: hidden" class="bgImg">
      <div style="width: 500px; height: 500px; background-color:lightyellow; border-radius: 10px;
        margin: 150px auto;">

        <div style="width: 360px; margin: 0 auto; padding-top: 100px">
          <div class="item" style="font-size: 30px; color: black ">校园二手交易平台</div>
          <br><br><br><br>
          <div class="item">

            <el-input type="text" class="inputItem" placeholder="请输入用户名" v-model="user.username">
              <template slot="prepend"  class="inputNotice">username</template>
            </el-input>

          </div>

          <div class="item">
              <el-input type="password" class="inputItem" placeholder="请输入密码" v-model="user.password">
                <template slot="prepend" class="inputNotice">password</template>
              </el-input>
          </div>
