...
export default {
  ...
  data() {
    return {
      ...
      praiseActiveIcon: require("../../assets/点赞.png"),
      collectActiveIcon: require("../../assets/收藏.png"),
      num: 1,
      id: 1,
      user: {},
      goods: {imgs: []},
  ...
  methods: {
    collect() {
      this.collectActiveIcon = require("../../assets/收藏-激活.png"),
    ...
    praise() {
      this.praiseActiveIcon = require("../../assets/点赞-激活.png")
      if (this.praiseFlag) {
        this.$message({
          message: "您已点过赞",
          type: "warning"
